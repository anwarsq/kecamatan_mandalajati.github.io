...
$sql = "UPDATE buat_saw SET `status`='$status', keterangan='$keterangan' WHERE id=$id_data";
...
// $email=$_POST['email'];
    ...
    if($status == "Diterima"){
        ...
        <h3>Selamat, pengajuan anda dengan id '.$id_data.'sudah diterima!</h3>
    ...
    $mail->AltBody = 'This is the body in plain text for non-HTML mail clients';
        ...
        $mail->Body    = '<div class="row">
        <h3>Mohon maaf pengajuan pembuatan Surat Ahli Waris anda belum dapat diterima terkait beberapa persyaratan yang tidak terpenuhi!</h3>
