...
$sql2 = "SELECT email FROM user WHERE username='$input_by'";
...
$sql = "UPDATE buat_surat_domisili SET `status`='$status', keterangan='$keterangan' WHERE id=$id_data";
...
try {
    ...
    $mail->addAddress('saepulanwar.ac@gmail.com', $nama);     // Add a recipient
...
// $email=$_POST['email'];
    ...
    $mail->Subject = 'Update Status Pengajuan Surat Domisili Perusahaan';
    if($status == "Diterima"){
    ...
    $mail->AltBody = 'This is the body in plain text for non-HTML mail clients';
        ...
        $mail->Body    = '<div class="row">
        <h3>Mohon maaf pengajuan pembuatan Surat Domisili Perusahaan anda belum dapat diterima terkait beberapa persyaratan yang tidak terpenuhi!</h3>
