...
if(isset($_POST['submit'])){
    ...
    if(isset($_POST['submit'])){
        ...
        $sql= "SELECT * FROM buat_ektp WHERE input_by='$nama_username'";
        $result = $connection->query($sql);
        $result;
    } 
}
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <?php 
                            ...
                            "<td align='center'>";
                            if($_SESSION['akun_level'] != "admin"){
                                if($row['status']!="Diterima"){echo "<a id='edit_data' data-toggle='modal' data-target='#edit-data' data-id_data='".$row['id']."'"."data-status='".$row['status']."'"."data-id_data2='".$row['id_data']."'"."data-nama='".$row['nama']."'"."data-nik='".$row['nik']."'"."data-nokk='".$row['nokk']."'"."data-tempat_lahir='".$row['tpt_lahir']."'"."data-tgl_lahir='".$row['tgl_lahir']."'"."data-pekerjaan='".$row['pekerjaan']."'"."data-agama='".$row['agama']."'"."data-status_kawin='".$row['status_kawin']."'".">
                                <button style='border-radius:8px;' class='btn btn-primary btn-xs'><i class='fa fa-edit'></i>Ubah</button>
                                </a>";
                                }
                            }else{
                                if($row['status']!="Diterima"){echo "<a id='edit_status' data-toggle='modal' data-target='#edit-status' data-id_data='".$row['id']."'"."data-status='".$row['status']."'"."data-id_data2='".$row['id_data']."'".">
                            ...
                            echo "<a id='hapus_data' data-toggle='modal' data-target='#hapus-data' data-id_data='".$row['id']."'"."data-nama='".$row['nama']."'".">
...
<div class="modal fade" id="hapus-data" tabindex="-1" role="dialog" aria-labelledby="exampleModalScrollableTitle" aria-hidden="true">
    ...
    <div class="modal-content">
        ...
        <div class="modal-body" id="modal-edit">
            ...
            <div class="form-group">
                <label for="nip">Yakin anda akan menghapus data atas nama <p name="nama" id="nama"></p> </label>
