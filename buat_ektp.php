...
$sql = "INSERT INTO buat_ektp (nama, nik, nokk, tpt_lahir, tgl_lahir, jns_kelamin, pekerjaan, agama, status_kawin, alamat, kelurahan, pengantar_rt, fc_kk, pass_photo, input_by, id_data) values('$nama', '$nik', '$nokk', '$tptLahir', '$tglLahir', '$jnsKelamin', '$pekerjaan', '$agama', '$kawin', '$alamat', '$kelurahan', '$pengantar','$fckk','$passfoto', '$nama_username', '$id_data')";
...
try {
    ...
    $mail->Subject = 'Record Formulir Pembuatan EKTP';
