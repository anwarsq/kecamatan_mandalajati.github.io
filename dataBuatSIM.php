...
if($_SESSION['akun_level'] == "admin"){
    $sql= "SELECT * FROM buat_sim";
    $result = $conn->query($sql);
    $result;
}else{
$sql= "SELECT * FROM buat_sim WHERE input_by='$nama_username'";
$result = $conn->query($sql);
$result;
}
        ...
        <div class="container-fluid" style="background-color: white; border-radius: 10px; width: 350%">
            ...
            <table class="table" id="myTable">
                <thead>
                    ...
                    <th scope="col">Surat Pindah Asal</th>
                    <th scope="col">Surat Jaminan</th>
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td><?php if($row['surat_pindah'] !=""){?><a href="images/<?php echo $row['surat_pindah'];?>">Lihat Surat</a><?php }else{echo "Tidak ada";}?></td>
                        <td><?php if($row['surat_jaminan'] !=""){?><a href="images/<?php echo $row['surat_jaminan'];?>">Lihat Surat</a><?php }else{echo "Tidak ada";}?></td>
                        ...
                        <?php 
                            ...
                            "<td align='center'>";
                            if($_SESSION['akun_level'] != "admin"){
                                if($row['status']!="Diterima"){echo "<a id='edit_data' data-toggle='modal' data-target='#edit-data' data-id_data='".$row['id']."'"."data-status='".$row['status']."'"."data-id_data2='".$row['id_data']."'"."data-nama='".$row['nama']."'"."data-nik='".$row['nik']."'"."data-pekerjaan='".$row['pekerjaan']."'"."data-alamat='".$row['alamat']."'"."data-input_by='".$row['input_by']."'".">
...
$(document).ready(function(e) {
    ...
    window.location="?page=dataBuatSIM";
    }));
});
