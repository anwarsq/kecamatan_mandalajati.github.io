...
<?php
    ...
    if(isset($_POST['submit'])){
        ...
        if(isset($konten) && !empty($konten)){
                $insert_q = "INSERT INTO pengumuman (isi, tanggal, penulis) values('$konten', '$tanggal', '$penulis')";
...
<div class="kotak">
    ...
    <form id="form-artikel" action="" method="POST" enctype="multipart/form-data">
        ...
        ?php } ?> -->
        <!-- <br> -->
        <label for="artikel" style="color:#fff; font-weight:bold;">Masukan penjelasan tentang sistem atau Kecamatan :</label>
