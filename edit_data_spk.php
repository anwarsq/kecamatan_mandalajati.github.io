...
$sql = "UPDATE buat_spk SET nama='$nama', nik='$nik', pekerjaan='$pekerjaan', alamat_asal='$alamat_asal', alamat_tujuan='$alamat_tujuan', status='Baru', tanggal_input='$tanggal' WHERE id=$id_data";
...
// $email=$_POST['email'];
    ...
    $mail->Subject = 'Update Status Pengajuan Surat Pindah Keluar';
