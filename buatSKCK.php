...
<div class="main">
    <div class="container-fluid" style="background-color:white; margin-bottom:10px; padding-bottom:10px; padding-top:10px;">
        <form id="form-skck" action="buat_skck.php" enctype="multipart/form-data" method="post" onsubmit="return confirm('Dengan ini saya menyatakan bahwa data yang saya isikan sudah benar!');">
            ...
            <div>
                ...
                <hr>
                    ...
                    <div class="row form-group">
                        <div class="col-md-2">
                            <label for="fcktp">Fotocopy KTP</label>
                        </div>
                        <div class="col-md-10">
                            <input class="form-control" type="file" id="fcktp" name="fcktp" required>
                        </div>
                    </div>
                    <div class="row form-group">
                        <div class="col-md-2">
